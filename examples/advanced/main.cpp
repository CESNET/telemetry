 ...
 */
std::unique_ptr<DataCenter> createDataCenter(
...
createDataCenters(std::shared_ptr<telemetry::Directory>& dataCentersDir, telemetry::Holder& holder)
{
	...
	dataCenters.push_back(createDataCenter("prague", dataCenterId, dataCentersDir, holder));
	dataCenters.push_back(createDataCenter("new_york", dataCenterId, dataCentersDir, holder));
	dataCenters.push_back(createDataCenter("tokyo", dataCenterId, dataCentersDir, holder));
